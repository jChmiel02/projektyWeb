document.addEventListener('DOMContentLoaded', function() {
    ...
    const options = {
        ...
        plugins: {
            title: {
                display: true,
                text: `Wykres przedstawiający udział poszczególnych kategorii w wydatkach. Suma wszystkich wydatków: ${sumaWydatkow}`
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editLinks.forEach(function(link) {
        link.addEventListener('click', function(e) {
            ...
            const wydatki = document.querySelectorAll('.wydatekItem');
            wydatki.forEach(function(item) {
            ...
            wydatkiForm.style.display = 'none';
