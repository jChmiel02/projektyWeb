...
<head>
    ...
    <title>Stałe Wydatki</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css"
          rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN"
          crossorigin="anonymous">
    <link href="{{ asset('/CSS/staleWydatkiStyle.css') }}" rel="stylesheet">
...
<div class="container-fluid">
    <div class="row text-center">
        <h1>Tutaj uzupełnij swoje stałe wydatki
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="infoModalLabel">Informacje o stronie Stałe wydatki</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body1">
                    <p>Podstrona 'Stałe wydatki' pozwala użytkownikowi wprowadzić typ wydatków, które są cykliczne. Są
                        to na przykład opłaty za mieszkanie czy samochód.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-3 styled-column">
                    <form method="POST" action="{{ route('staleWydatki') }}" id="staleWydatkiForm">
                        @csrf
                        <div class="styled-box">
                            ...
                            <div class="mb-3">
                                <label for="kategoria" class="form-label"><strong>Wpisz kategorię
                    ...
                    @if(count($staleWydatki) > 0)
                        @foreach($staleWydatki as $wydatek)

                            <div id="editFormContainer" style="display: none;">
                                <h2>Edycja wydatku:</h2>
                                <form method="POST" action="{{ route('updateStalyWydatek', ['id' => $wydatek->id]) }}"
                                      id="editWydatekForm">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="editKategoria" class="form-label"><strong>Kategoria
                                                    wydatku:</strong></label>
                                            <input type="text" name="editKategoria" id="editKategoria"
                            ...
                            @foreach($staleWydatki as $wydatek)
                                <li class="list-group-item wydatekItem" data-wydatek-id="{{ $wydatek->id }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <form method="POST"
                                                  action="{{ route('deleteStalyWydatek', ['id' => $wydatek->id]) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger">Usuń</button>
                                            </form>
                                            <a href="#" class="btn btn-primary editWydatek"
                                               data-id="{{ $wydatek->id }}">Edytuj</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
...
<script src="{{ asset('/JS/staleWydatkiScript.js') }}"></script>
